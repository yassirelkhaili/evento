                ...
                <form class="max-w-lg mx-auto" action={{ route('index.filter') }}>
                    <div class="flex">
                        ...
                        <button id="dropdown-button" data-dropdown-toggle="dropdown"
                            ...
                            type="button"><span>All categories</span>
                        ...
                        <div id="dropdown"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(356.667px, 147.333px, 0px);"
                            class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                @foreach ($categories as $category)
                                    <li>
                                        <button data-element="dropdown-button" type="button"
                                            class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-md"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    @forelse ($events as $event)
                        <div
                            ...
                            <a href="#">
                                <img class="h-32 w-full" src="{{ asset('storage/events/' . $event->event_picture) }}"
                                    alt="" />
                            </a>
                            <div class="p-5">
                                <a href="#">
