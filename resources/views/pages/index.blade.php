...
<x-layouts.marketing>
    ...
    @volt('home')
        <div class="relative flex flex-col items-center justify-center w-full h-auto overflow-hidden" x-cloak>
            ...
            <div class="flex items-center w-full max-w-6xl px-8 pt-6 pb-20 mx-auto">
                <div class="container relative max-w-4xl mx-auto text-center">
                    <div style="background-image:linear-gradient(160deg,#e66735,#e335e2 50%,#73f7f8, #a729ed)" class="inline-block w-auto p-0.5 shadow rounded-full animate-gradient">
                        <p class="w-auto h-full px-3 bg-slate-50 dark:bg-neutral-900 dark:text-white py-1.5 font-medium text-sm tracking-widest uppercase  rounded-full text-slate-800/90 group-hover:text-white/100">Welcome to Evento</p>
                    </div>
                    <h1 class="mt-5 text-4xl font-light leading-tight tracking-tight text-center dark:text-white text-slate-800 sm:text-5xl md:text-8xl">Unlock the Door to<br> Next-Level Experiences.</h1>
                    <p class="w-full max-w-3xl mx-auto mt-8 text-lg dark:text-white/60 text-slate-500">Our platform is your gateway to a universe of extraordinary events, offering seamless access and personalized control over your journey. With features like instant ticket booking, dynamic event exploration, interactive user dashboards. </p>
                    <div class="flex items-center justify-center w-full max-w-sm px-5 mx-auto mt-8 space-x-5">
                        <x-ui.button type="secondary" tag="a" href="https://github.com/thedevdojo/genesis" target="_blank">View Github Repo</x-ui.button>
                        <x-ui.button type="primary" tag="a" href="https://github.com/thedevdojo/genesis" target="_blank">Browse Events</x-ui.button>
                    </div>
                </div>
            </div>
