                                        ...
                                        <ul class="py-1 text-sm"
                                            ...
                                            <li>
                                                <form action="{{route("event.approve", "$event->id")}}" method="POST">
                                                    @csrf
                                                <button data-id="{{$event->id}}" type="submit" class="editBtn flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
