                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="{{ $partner->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="{{ $partner->id }}-dropdown-button">
                                        ...
                                        <li>
                                            <button type="button" data-partner-id="{{$partner->id}} " data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="deleteBtn flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
                                                Delete
                                            </button>
                                        </li>
                                    </ul>
